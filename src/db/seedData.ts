...
const menuItemsData: Omit<MenuItem, 'id'>[] = [
  ...
  { name: 'इडली साम्भर', category: 'भारतीय > दक्षिण भारतीय', price: 90, available: true, archived: false, createdAt: now, updatedAt: now },
  ...
  // अंतर्राष्ट्रीय > इटालियन
  { name: 'मार्गेरीटा पिज़्ज़ा', category: 'अंतर्राष्ट्रीय > इटालियन', price: 260, available: true, archived: false, createdAt: now, updatedAt: now },
  { name: 'वेजी पास्ता', category: 'अंतर्राष्ट्रीय > इटालियन', price: 210, available: true, archived: false, createdAt: now, updatedAt: now },
  { name: 'व्हाइट सॉस पास्ता', category: 'अंतर्राष्ट्रीय > इटालियन', price: 230, available: true, archived: false, createdAt: now, updatedAt: now },

  // अंतर्राष्ट्रीय > स्ट्रीट फूड
  { name: 'वेज बर्गर', category: 'अंतर्राष्ट्रीय > स्ट्रीट फूड', price: 130, available: true, archived: false, createdAt: now, updatedAt: now },
  { name: 'ग्रिल्ड सैंडविच', category: 'अंतर्राष्ट्रीय > स्ट्रीट फूड', price: 140, available: true, archived: false, createdAt: now, updatedAt: now },
  { name: 'वेज मैगी', category: 'अंतर्राष्ट्रीय > स्ट्रीट फूड', price: 95, available: true, archived: false, createdAt: now, updatedAt: now },
  { name: 'फ्रेंच फ्राइज़', category: 'अंतर्राष्ट्रीय > स्ट्रीट फूड', price: 110, available: true, archived: false, createdAt: now, updatedAt: now },
...
export async function loadDemoData(): Promise<void> {
  await db.transaction('rw', [db.menuItems, db.restaurantTables, db.diningSessions, db.orderItems, db.serviceRequests, db.payments], async () => {
    ...
    await addOrderItems(session1Id as number, 1, minutesAgo(40), [
      { name: 'मसाला डोसा', qty: 2, status: 'submitted', specialInstructions: ['अतिरिक्त कुरकुरा'] },
      { name: 'फ़िल्टर कॉफ़ी', qty: 2, status: 'submitted' },
    ]);

    await addOrderItems(session2Id as number, 3, minutesAgo(25), [
      { name: 'मार्गेरीटा पिज़्ज़ा', qty: 1, status: 'preparing', specialInstructions: ['कम मसालेदार'] },
    ...
    const historicalEntries: HistEntry[] = [
      ...
      { day: 2, hour: 6, tableNum: 7, items: [{ name: 'मार्गेरीटा पिज़्ज़ा', qty: 1 }, { name: 'मैंगो शेक', qty: 1 }] },
      { day: 3, hour: 1, tableNum: 3, items: [{ name: 'इडली साम्भर', qty: 2 }, { name: 'फ़िल्टर कॉफ़ी', qty: 2 }] },
